...
%% if wec.show_details
\begin{itemize}
    %% for detail in slice_values(job.details, wec.get('show_details', True))
...
\vspace{-\baselineskip}
\begin{multicols}{2}
%% set show_projects = osec.get('show_projects', True)
%% for project in slice_values(cvdata.open_source, show_projects)
\textbf{%
%% if project.url
...
%% set show = cvdata.teaching_experience or tec.get('show_teaching', True)
